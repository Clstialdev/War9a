...
class DraggableView extends Component {
    constructor(props) {
        super(props);
        const initialUsedSpace = +this.props.initialDrawerSize;
        let distance = SCREEN_HEIGHT * (1 - initialUsedSpace);
        const initialDrawerSize = distance < 614 ? distance : 580 ;
    ...
    componentWillReceiveProps(nextProps) {
        ...
        // alert(this.state.initialPositon);
